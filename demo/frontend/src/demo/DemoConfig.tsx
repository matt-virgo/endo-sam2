...
export const VIDEO_API_ENDPOINT = 'https://34.30.126.171:7263';
export const INFERENCE_API_ENDPOINT = 'https://34.30.126.171:7263';
...
export const IS_FB_INTERNAL_USER_BUILD = false;
